...
TYPES = {
    ...
    "qwop2": "XT_QUAD", "scst5": "XT_SCST5", "ucst5": "XT_UCST5", "long": "XT_LONG", "xlong": "XT_XLONG",
}
...
# SHRU of a 40-bit long has the same fixed x=0 in binutils; the same helper
# shifts over the cross path (shru .S1X b5:b4,a3,a9:a8 at 0x0080CC6C,
# shru .S2X a7:a6,19,b5:b4 at 0x0080D56C). SPRUGH7 2.4 lists the 40-bit
# forms of ABS, ADD, CMPxx, NORM, SADD, SAT, SHL, SHR, SHRU, SSUB and SUB
# as cross-capable on the C66x; these are the ones the firmware uses.
rows.append(("SHRU", "XF_S12", "S", 0x25, ["src2", "src1", "dst"], ["xlong", "op1", "long"]))
rows.append(("SHRU", "XF_S12", "S", 0x24, ["src2", "src1", "dst"], ["xlong", "ucst5", "long"]))
